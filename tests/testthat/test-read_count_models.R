test_that("read count data files can be loaded and processed", {
  ...
  read1_file <- system.file("extdata", "example_read1_no_host.txt", package = "snp.slicer")
  read0_file <- system.file("extdata", "example_read0_no_host.txt", package = "snp.slicer")
